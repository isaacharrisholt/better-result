...
declare const matchErrorPartial: {
  <E extends AnyTaggedError, R>(err: E, handlers: Partial<MatchHandlers<E, R>>, fallback: (e: E) => R): R;
  <E extends AnyTaggedError, R>(handlers: Partial<MatchHandlers<E, R>>, fallback: (e: E) => R): (err: E) => R;
};
/**
...
declare const Result: {
   ...
   * Result.ok(42) // Ok(42)
   */
  readonly ok: <A, E = never>(value: A) => Ok<A, E>;
  /**
   * Type guard for Ok.
   *
   * @example
   ...
   */
  readonly deserialize: <T, E>(value: unknown) => Result<T, E> | null;
  /**
   * @deprecated Use `Result.deserialize` instead. Will be removed in 3.0.
   */
  readonly hydrate: <T, E>(value: unknown) => Result<T, E> | null;
  /**
...
//#endregion
export { Err, type InferErr, type InferOk, Ok, Panic, Result, type SerializedErr, type SerializedOk, type SerializedResult, TaggedError, type TaggedErrorClass, type TaggedErrorInstance, UnhandledException, isPanic, isTaggedError, matchError, matchErrorPartial, panic };
